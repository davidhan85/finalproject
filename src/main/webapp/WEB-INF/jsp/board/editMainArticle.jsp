									...
									<div class="card">
										...
										<div class="card-body">
											<form:form class="form-select" modelAttribute="mainarticles"
												...
												<form:input path="mainid" class="form-control"
													value="${mainarticles.mainid}"></form:input>
												<form:input path="title" class="form-control"
													value="${mainarticles.title}"></form:input>
												<form:input path="authoridforMA" class="form-control"
													value="${mainarticles.authoridforMA.m_number}"></form:input>
												<form:select path="category" class="form-control" name="category" id="">
													<option value="${mainarticles.category}">${mainarticles.category}
													</option>
												...
												<form:select path="access" class="form-control" name="access" id="">
													<option value="${mainarticles.access}">${mainarticles.access}
													</option>
													<c:if test="${memberbean.m_Role eq'adaim'}">
												...
												<form:textarea path="content" class="form-control" id="editorDemo"
													cols="30" value="${mainarticles.content}"></form:textarea>
