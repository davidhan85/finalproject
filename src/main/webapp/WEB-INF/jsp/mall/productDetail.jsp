        ...
        <div class="row gx-5">
            <aside class="col-lg-6">
                <div class="border rounded-4 mb-3 d-flex justify-content-center">
                    <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" href="<jstl:url value='/ProductImage/${listedProduct.productImage.productImageId}'/>">
                        <img style="max-width: 100%; max-height: 100vh; margin: auto;" class="rounded-4 fit" src="<jstl:url value='/ProductImage/${listedProduct.productImage.productImageId}'/>" />
                    </a>
                </div>
...
<%--            <div class="p-image">--%>
<%--                <img src="<jstl:url value='/ProductImage/${listedProduct.productImage.productImageId}'/>" width="200">--%>
